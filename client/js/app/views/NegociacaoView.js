...
System.register(['./View', '../models/ListaNegociacoes', '../helpers/DataHelper'], function (_export, _context) {
    "use strict";

    var View, ListaNegociacoes, DataHelper, _createClass, NegociacaoView;
            ...
            _export('NegociacaoView', NegociacaoView = function (_View) {
                ...
                _createClass(NegociacaoView, [{
                    ...
                    value: function template(model) {
                        return '\n        <table class="table table-hover table-bordered">\n            <thead>\n                <tr>\n                    <th>DATA</th>\n                    <th>QUANTIDADE</th>\n                    <th>VALOR</th>\n                    <th>VOLUME</th>\n                </tr>\n            </thead>\n\n            <tbody>\n                ' + model.lista.map(function (n) {
                            return '\n                    <tr>\n                        <td>' + DataHelper.dataParaTexto(n.data) + '</td>\n                        <td>' + n.quantidade + '</td>\n                        <td>' + n.valor + '</td>\n                        <td>' + n.volume + '</td>\n                    </tr>\n                    ';
                        }).join('') + '\n            </tbody>\n\n            <tfoot>\n                <td colspan=3></td>\n                <td>\n                ' + model.lista.reduce(function (totalAnterior, negociacaoAtual) {
                            return totalAnterior + negociacaoAtual.volume;
                        }, 0) + '\n                </td>\n            </tfoot>\n        </table>\n        ';
                    }
                }]);
